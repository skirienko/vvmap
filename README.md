...
curl --output map.osm "https://z.overpass-api.de/api/map?bbox=131.75,42.9,132.4944,43.3497"
...
```bash
curl -G https://z.overpass-api.de/api/interpreter -H "Referer: https://vvmap.netlify.app/" --data-urlencode "data@vladivostok.overpassql" -o vladivostok.osm
```
